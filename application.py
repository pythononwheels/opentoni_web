...
from opentoni_web.database.sqldblib import Base, Session, engine
from opentoni_web.config import myapp
from opentoni_web.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'opentoni_web.handlers.' + m)    
            try:
                mod = importlib.import_module('opentoni_web.handlers.' + m)
            except:
                pass
            #print(dir(mod))
