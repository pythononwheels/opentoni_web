from opentoni_web.powlib import pluralize
import datetime
...
from opentoni_web.encoders import pow_json_serializer
from opentoni_web.decoders import pow_json_deserializer
...
class ModelObject():
    ...
    def init_from_dict(self, d, ignore=True, simple_conversion=False):
        ...
        """
        from opentoni_web.decoders import pow_init_from_dict_deserializer
