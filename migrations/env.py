...
from opentoni_web.powlib import get_class_name
from opentoni_web.config import myapp
from opentoni_web.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('opentoni_web.models.sql.' + m)
...
#from opentoni_web.dblib import Base
